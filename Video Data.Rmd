...
Taking previous chunk cox model with cluster (option b) and adding time-varying coefficient to allow interaction with log(time). <old title not what's here 
```{r}
...
```{r}
#Attempting to visualize the above cox model, chat assisted, might be garbage
