...
treatments_morts_simplify %>%
  ...
  geom_col(position = "dodge") +
   scale_y_continuous(expand = c(0, 0)) + # removes gap between bars and x axis
...
```{r}
# Looks good except need to change order of bars to make more sense
treatments_morts_dets %>%
  ...
  geom_col(position = "dodge") +
   ...
   scale_x_discrete(labels = c("Moult Failure" = "Moult Failure",
                              ...
                              "Moult Failure + Cannibalism" = "Moult Failure -> Cannibalism", "Cannibalism + Moult Failure" = "Cannibalim -> Moult Failure")) +
  labs(
    x = "Cause of Death",
    y = "Number of Mortalities"
  ) +
