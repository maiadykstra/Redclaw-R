...
mslr_df <- carapace_lengths %>%
  ...
  filter(Day != 15) # Change treatment and day filter to utilize below code as pairwise test
...
wilx <- wilcox.test(mort_time$Day, mort_time$Night, paired = TRUE)
wilx
...
fisher <- fisher.test(ctable_cann_stage)
fisher
