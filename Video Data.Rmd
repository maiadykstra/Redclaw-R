...
Adding AM/PM to mortality details summary data frame
```{r}
treatments_morts_dets <- treatments_morts_dets %>%
...
ctable_cause <- xtabs(~ treatment + Cause, data = treatments_morts_dets)

ctable_stage <- xtabs(~ treatment + Stage, data = treatments_morts_dets)

ctable_time <- xtabs(~ treatment + time, data = treatments_morts_dets)
