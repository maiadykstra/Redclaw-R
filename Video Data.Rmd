...
ggplot() +
  ...
  labs(
    y = "Probability Cannibalized Animal is Uncalcified",
    x = "Day",
    color = "Light Period",
    fill = "Light Period"
  ) +
...
ggplot(binom_moult_light, aes(x = day_number, y = light_bin)) +
  ...
  geom_smooth(method = "glm", method.args = list(family = "binomial"),
              se = TRUE, color = "blue") +
  ylab("Probability of Moult Occuring During Light vs. Dark Period") + 
  xlab("Days")
...
l1 = c(2/9, 3/10, 4/8, 5/10)*100
l2= c(7/9, 7/10, 4/8, 5/10)*100
diffs = l1-l2
diffs
...
ggplot(aes(x = Stage, y = percent, fill = Stage)) +
  ...
  labs(
    x = "Moult Stage",
    y = "Percentage of Cannibalism Victims"
  ) +
  theme_minimal(base_size = 14) +
  theme(
    legend.position = "none",
